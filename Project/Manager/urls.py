...
urlpatterns = [
    ...
    path('add_leave/<int:employee_id>/', add_leave_by_id, name='add_leave_by_id'),
    ...
    path('employee_leaves/<int:employee_id>/', show_employee_leaves, name='show_employee_leaves'),
]
